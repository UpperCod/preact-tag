	        ...
	        var prop = props[i],
	            value =
	                element instanceof HTMLElement
	                    ...
	                    : element[prop];
	        data[
	            prop.replace(/-+([\w])/g, function (all, letter) { return letter.toUpperCase(); })
	        ] = /^json-/.test(prop) ? JSON.parse(value) : value;
	    }
	    return data;
	}

	function register(tag, Component$$1) {
	    var props = Component$$1.props || [];
	    customElements.define(
	        ...
	        class extends HTMLElement {
	            ...
	            attributeChangedCallback(index, prev, next) {
	                ...
	                this.render(Object.assign({}, getProps(props, this),
	                    getProps([index], ( obj = {}, obj[index] = next, obj ))));
	            }
	        }
	    );
	}
